 ...
 ZCRMRestClient.initialize = function(configJSON){
    return new Promise(function(resolve,reject){
        if(configJSON){
            ...
            var databasehost  = configJSON.database_host || 'localhost';
            var databasename  = configJSON.database_name || 'zohooauth';
            ...
            ZCRMRestClient.setDatabaseHost(databasehost);
            ZCRMRestClient.setDatabaseName(databasename);
...
ZCRMRestClient.generateAuthTokens = function(user_identifier,grant_token){
    ...
    return new Promise(function(resolve,reject){
        ...
        OAuth.generateTokens(api_url).then(function(response){
            ...
            var mysql_util = require('./mysql/mysql_util');
            var resultObj = ZCRMRestClient.parseAndConstructObject(response);
            resultObj.useridentifier = user_identifier;
...
ZCRMRestClient.setDatabaseHost = function(databasehost){
    database_host = databasehost;
}
ZCRMRestClient.setDatabaseName = function(databasename){
...
ZCRMRestClient.getDatabaseHost = function(){
    return database_host;
}
ZCRMRestClient.getDatabaseName = function(){
